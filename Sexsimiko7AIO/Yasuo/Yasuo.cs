...
namespace Sexsimiko7AIO.Yasuo
{
    internal class Yasuo
    {
        ...
        static Yasuo()
        {
            ...
            Menu = MainMenu.AddMenu("Sexsimiko7AIO Yasuo", "mikoyasuo");
            ...
            ComboMenu.Add("combo.leftclickRape", new CheckBox("Left Click Rape", false));
            ComboMenu.AddSeparator();
            ComboMenu.AddLabel("R Settings");
            ComboMenu.Add("combo.R", new CheckBox("Use R"));
            ComboMenu.Add("combo.RTarget", new CheckBox("Use R always on Selected Target", false));
